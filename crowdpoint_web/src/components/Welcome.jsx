...
const Welcome = () => {
  return (
    ...
    <p className="font-bold  px-5  text-lg">
      Welcome to Crowd Point, a platform for ......
    </p>
    ...
    <div className="flex justify-center pb-5">
      <p className="font-extrabold p-4 w-4/6 text-center ml-7 bg-gray-200 border border-red-400  rounded-full hover:bg-red-500   text-lg">
        Download Now 
      </p>
    </div>
    <p className="font-bold  px-5  text-lg">
